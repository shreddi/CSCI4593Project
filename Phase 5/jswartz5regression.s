...
_start:
 ...
 /*
    Immediate (i-type) ALU operations
     ...
     ■ andi
 */ 
    addi x4, x0, (-1) //set x4 to -1 for future tests
    nop
    nop
    nop
    addi x5, x0, (-2) //set x5 to -2 for future tests
    nop               //x4 = -1
    nop
    nop
 ...
 */
    ...
    nop
    nop
    slt x3, x2, x4             //compare 1 to -1, not less than so x3 = 0
    nop                 // x3 = 1
    nop
    nop
    ...
    nop
    nop
    sra x3, x6, x2          //arithmetic shift 0xFFFFFF00 right by 1, x3 = 0x7FFFFF80
    nop                 // x6 = 0xFFFFFF00
    nop
    nop
    sra x3, x2, x2          //arithmetic shift 0x00000001 right by 1, x3 = 0x00000000
    nop                 // x3 = 0xFFFFFF80
    nop
    nop
 ...
 */
    ...
    nop//ID
    nop//EX
    slli x3, x4, 0//MEM         //shift 0xFFFFFFFF left by 0, x3 = 0xFFFFFFFF
    nop//WB                 //x3 = 0xFFFFFFFe
    nop
    nop
    ...
    //srai
    srai x3, x6, 1          //logical shift 0xFFFFFF00 right by 1, x3 = 0xFFFFFF80 
    nop                 // x3 = 0x00000000
    nop
    nop
